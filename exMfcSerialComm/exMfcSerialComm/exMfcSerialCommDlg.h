...
class CexMfcSerialCommDlg : public CDialogEx
{
	// 생성입니다.
public:
	CexMfcSerialCommDlg(CWnd* pParent = nullptr);	// 표준 생성자입니다.
	/*#####################################*/
	// flags 
...
// 대화 상자 데이터입니다.
	...
	enum { IDD = IDD_EXMFCSERIALCOMM_DIALOG };
#endif
